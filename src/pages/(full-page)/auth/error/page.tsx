...
const Error = () => {
    ...
    return (
        <div className="h-screen flex flex-column bg-cover" style={{ backgroundImage: "url('/layout/images/pages/error-bg.jpg')" }}>
            ...
            <div className="align-self-center mt-auto mb-auto">
                <div className="text-center z-5 flex flex-column border-1 border-round-md surface-border surface-card px-3">
                    <div className="-mt-5 text-white bg-pink-500 border-round-md mx-auto px-3 py-1 border-1 surface-border">
                        <h2 className="m-0">ERROR</h2>
                    </div>

                    <h4>Something went wrong.</h4>

                    <div className="text-color-secondary mb-6 px-6">Please contact the system administrator.</div>

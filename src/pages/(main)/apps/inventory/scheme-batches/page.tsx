...
export default function InventorySchemeBatchesPage() {
    const nameInputId = 'scheme-batch-name-input';
    const saveButtonId = 'scheme-batch-save-button';
    ...
    const confirmDelete = async (event: React.MouseEvent<HTMLButtonElement>, row: SchemeBatchRow) => {
            ...
            <div className="flex flex-column gap-2 mb-3">
                <div className="flex flex-column md:flex-row md:align-items-start md:justify-content-between gap-3">
                    ...
                    <div className="flex gap-2 flex-wrap justify-content-end align-items-start">
                        <Button className="app-action-compact" label="New Batch" icon="pi pi-plus" onClick={openNew} disabled={!masterPermissions.canAdd} />
                        <AppHelpDialogButton {...getMasterPageHelp('schemeBatches')} buttonAriaLabel="Open Scheme Batches help" />
                    </div>
                </div>

            ...
            <div className="grid app-entry-footer-party-row">
                {isCashMode && (
                    <div className="col-12 md:col-4">
                        <AppNotchedField
                            label={<LabelWithIcon icon="pi-user">Paid By</LabelWithIcon>}
                            className="app-notched-input--paid-by"
                            style={{ width: '220px' }}
                            htmlFor="payment-voucher-paid-by"
                        >
                            <AppAutoComplete
                                inputId="payment-voucher-paid-by"
                                value={managerValue}
                ...
                <div className="flex flex-wrap app-entry-form-actions">
                    {voucherActions.saveForm.visible && !editingId ? (
                        <div className="app-entry-form-toggle-with-hint">
                            <label htmlFor="payment-voucher-add-another-after-save" className="app-entry-form-toggle">
                                <Checkbox
                                    inputId="payment-voucher-add-another-after-save"

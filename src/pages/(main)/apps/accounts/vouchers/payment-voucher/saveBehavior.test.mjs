...
const saveBehaviorModule = loadTsModule('src/pages/(main)/apps/accounts/vouchers/payment-voucher/saveBehavior.ts');
const preferencesModule = loadTsModule('src/pages/(main)/apps/accounts/vouchers/payment-voucher/preferences.ts');

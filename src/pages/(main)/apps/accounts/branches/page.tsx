...
export default function AccountsBranchesPage() {
    ...
    const [detailRow, setDetailRow] = useState<BranchRow | null>(null);
            ...
            <div className="flex flex-column gap-2 mb-3">
                <div className="flex flex-column md:flex-row md:align-items-start md:justify-content-between gap-3">
                    ...
                    <div className="flex gap-2 flex-wrap justify-content-end align-items-start">
                        <Button className="app-action-compact" label="New Branch" icon="pi pi-plus" onClick={openNew} />
                        <AppHelpDialogButton {...getMasterPageHelp('branches')} buttonAriaLabel="Open Branches help" />
                    </div>
                </div>
